jQuery(document).ready(function () {
		jQuery('.save-colorbox-options').click(function(){
		alert("colorbox Settings are disabled in free version. If you need those functionalityes, you need to buy the commercial version.");
		return false;
	});
